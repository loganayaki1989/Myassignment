...
public class Delete {
	...
	public static void main(String[] args)throws InterruptedException {
		...
		use.findElement(By.xpath("//p[@class='top']//input")).sendKeys("demoSalesManager");
		use.findElement(By.xpath("//input[@id='username']/following::input")).sendKeys("crmsfa");
		use.findElement(By.xpath("(//form[@id='login']//input)[3]")).click();
		use.findElement(By.xpath("//a[contains(text(),'CRM')]//parent::div")).click();
		Thread.sleep(2000);
